...
export interface Tab {
  id: string;
  type: 'chat' | 'agent' | 'agents' | 'projects' | 'usage' | 'mcp' | 'settings' | 'claude-md' | 'claude-file' | 'agent-execution' | 'create-agent' | 'import-agent' | 'governance' | 'xray' | 'semantic-search' | 'call-graph' | 'git-context' | 'checkpoint' | 'factory' | 'portfolio' | 'promotion' | 'workspace-projects' | 'live-sessions' | 'decomposition';
  title: string;
...
// const STORAGE_KEY = 'opc_tabs'; // No longer needed - persistence disabled
const MAX_TABS = 20;
