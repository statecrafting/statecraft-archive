...
| Your code | `src/` and `scripts/` | The implementation that specs govern |
...
- **Verification** (the command that confirms the step: `bun run typecheck`, `spec-spine compile`, `spec-spine lint`, `spec-spine couple`)
