...
// Interactive inline-SVG diagram: clickable nodes reveal a description tooltip.
// Ported from the OAP whitepaper site, with framer-motion swapped for a plain
// CSS transition so the paper reader carries no animation dependency.
