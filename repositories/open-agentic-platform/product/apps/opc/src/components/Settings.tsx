                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <p className="text-caption text-muted-foreground">
                          Help improve opc by sharing anonymous usage data
                        </p>
                      </div>
                      <Switch
              ...
              <Card className="p-6">
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      Override the default model for all Claude Code sessions
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5 flex-1">
                      <Label htmlFor="disableNonEssentialTraffic">Disable Non-Essential Traffic</Label>
                      <p className="text-caption text-muted-foreground">
                        Disables telemetry, crash reports, and automatic update checks
                      </p>
                    </div>
                    <Switch
                      id="disableNonEssentialTraffic"
                      checked={settings?.disableNonEssentialTraffic === true}
                      onCheckedChange={(checked) => updateSetting("disableNonEssentialTraffic", checked || undefined)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5 flex-1">
                      <Label htmlFor="fallbackAvailableNotice">Show Fallback Model Notice</Label>
                      <p className="text-caption text-muted-foreground">
                        Show a notice when Claude falls back to a different model
                      </p>
                    </div>
                    <Switch
                      id="fallbackAvailableNotice"
                      checked={settings?.fallbackAvailableNotice !== false}
                      onCheckedChange={(checked) => updateSetting("fallbackAvailableNotice", checked === false ? false : undefined)}
                    />
                  </div>
                  ...
                  {/* Theme */}
                  <div className="space-y-2">
                    <Label htmlFor="theme">Terminal UI Theme</Label>
                    <select
                      id="theme"
                      className="flex h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                      value={settings?.theme || ""}
                      onChange={(e) => updateSetting("theme", e.target.value || undefined)}
                    >
                    ...
                    <p className="text-xs text-muted-foreground">
                      Claude Code's terminal UI color theme (independent of opc's theme)
                    </p>
                  </div>

                  {/* Preferred Notification Channel */}
                  <div className="space-y-2">
                    <Label htmlFor="preferredNotifChannel">Preferred Notification Channel</Label>
                    <Input
                      id="preferredNotifChannel"
                      placeholder="e.g. iterm2, terminal-notifier"
                      value={settings?.preferredNotifChannel || ""}
                      onChange={(e) => updateSetting("preferredNotifChannel", e.target.value || undefined)}
                    />
                    <p className="text-xs text-muted-foreground">
                      Notification delivery method (e.g. <code className="px-1 py-0.5 rounded bg-muted">iterm2</code>, <code className="px-1 py-0.5 rounded bg-muted">terminal-notifier</code>)
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5 flex-1">
                      <Label htmlFor="autoUpdaterDisabled">Disable Auto-Updater</Label>
                      <p className="text-caption text-muted-foreground">
                        Prevent Claude Code from self-updating automatically
                      </p>
                    </div>
                    <Switch
                      id="autoUpdaterDisabled"
                      checked={settings?.autoUpdater?.disabled === true}
                      onCheckedChange={(checked) =>
                        updateSetting("autoUpdater", checked ? { disabled: true } : undefined)
                      }
                    />
                  </div>
                </div>
