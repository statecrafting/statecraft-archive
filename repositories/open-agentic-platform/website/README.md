# Open Agentic Platform documentation website

This directory contains the Docusaurus v3 documentation site for Open Agentic Platform.
...
This starts a local dev server at `http://localhost:3000/open-agentic-platform/` and opens a
