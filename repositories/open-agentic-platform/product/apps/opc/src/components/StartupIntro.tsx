...
import opcLogo from "../../src-tauri/icons/icon.png";
      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            {/* opc logo slides left; brand text reveals to the right */}
...
function BrandText() {
  return (
    <div className="text-5xl font-extrabold tracking-tight brand-text">
      <span className="brand-text-solid">opc</span>
      <span aria-hidden="true" className="brand-text-shimmer">opc</span>
    </div>
  );
}
