...
- When you need to understand how a route, loader, or component works
- To trace a dependency chain across this codebase
...
| Site code | `app/`, `public/`, `scripts/`, `react-router.config.ts`, `vite.config.ts` | The implementation governed by specs |
...
- Check `app/routes.ts` and the layouts to understand how pages compose
