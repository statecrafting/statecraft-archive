...
| Your code | `addon/`, `packages/`, `vendor/encore/` | Correctness, error handling, public API surface |
...
### Verification
- [ ] Builds cleanly (`npm run typecheck`; `npm run build` in each addon touched)
