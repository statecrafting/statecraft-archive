...
| Your code | `addon/`, `packages/`, `vendor/encore/` | The implementation that specs govern |
...
- **Verification** (the command that confirms the step: `npm run typecheck`, `npm test`, `npm run build` in a touched addon, `spec-spine compile`, `spec-spine lint`, `spec-spine couple`)
