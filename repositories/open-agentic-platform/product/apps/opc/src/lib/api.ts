...
export const api = {
  ...
  async listAgentRuns(agentId?: number): Promise<AgentRunWithMetrics[]> {
    try {
      return await apiCall<AgentRunWithMetrics[]>('list_agent_runs', agentId !== undefined ? { agentId } : undefined);
    } catch (error) {
  ...
  async listAgentRunsWithMetrics(agentId?: number): Promise<AgentRunWithMetrics[]> {
    try {
      return await apiCall<AgentRunWithMetrics[]>('list_agent_runs_with_metrics', agentId !== undefined ? { agentId } : undefined);
    } catch (error) {
