...
export function Environment(name: string): BaseURL {
    return `https://${name}-trxiy.encr.app`
}
...
/**
 * Client is an API client for the trxiy Encore application.
 */
...
export namespace auth {
    ...
    export class ServiceClient {
        ...
        public async csrfToken(method: "GET", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/auth/csrf-token`, body, options)
        }

        public async drivers(): Promise<{
    drivers: string[]
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/v1/auth/drivers`)
    ...
    drivers: string[]
         ...
         */
        public async login(method: "GET", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/auth/login`, body, options)
        }

        public async logout(method: "POST", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/auth/logout`, body, options)
        }

        public async me(): Promise<MeResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/v1/auth/me`)
            return await resp.json() as MeResponse
        }

        public async mockLogin(method: "GET", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
         ...
         */
        public async status(method: "GET", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/auth/status`, body, options)
        }
    }
}
...
export namespace gateway {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.dataPatch = this.dataPatch.bind(this)
            this.dataPost = this.dataPost.bind(this)
            this.dataPut = this.dataPut.bind(this)
        }

        public async dataDelete(method: "DELETE", path: string[], body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/data/${path.map(encodeURIComponent).join("/")}`, body, options)
        }

        public async dataGet(method: "GET", path: string[], body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/data/${path.map(encodeURIComponent).join("/")}`, body, options)
        }

        public async dataPatch(method: "PATCH", path: string[], body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/data/${path.map(encodeURIComponent).join("/")}`, body, options)
        }

        public async dataPost(method: "POST", path: string[], body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/data/${path.map(encodeURIComponent).join("/")}`, body, options)
        }

        public async dataPut(method: "PUT", path: string[], body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/data/${path.map(encodeURIComponent).join("/")}`, body, options)
        }
    }
}
...
export namespace health {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.cspReport = this.cspReport.bind(this)
         ...
         */
        public async cspReport(method: "POST", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/v1/csp-report`, body, options)
        }
        ...
        public async info(): Promise<InfoResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/v1/info`)
         ...
         */
        public async liveness(): Promise<HealthResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/health/liveness`)
            return await resp.json() as HealthResponse
        }
        ...
        public async readiness(): Promise<ReadinessResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/health/readiness`)
...
export namespace web {
    ...
    export class ServiceClient {
         ...
         */
        public async spa(path: string[]): Promise<void> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "trxiy-Generated-TS-Client (Encore/v1.57.8)";
        }
